/**
 * Admin analytics — summary rollup.
 *
 *   GET /api/admin/analytics/summary
 *     Returns headline counts and revenue aggregates over an optional
 ...
 *
 *     Response shape: see `OrdersSummary` in `lib/server/admin-analytics`.
 *
 * Authn / authz:
 *   - 401 when no session.
...
import { getOrdersSummary } from "@/lib/server/admin-analytics";
