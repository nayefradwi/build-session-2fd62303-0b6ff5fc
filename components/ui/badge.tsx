...
/**
 * Lightweight pill used for product merchandising labels (stock,
 * "New", "Featured", category tags, etc.). Mirrors the shadcn/ui
 * Badge API so it slots into the rest of the design system without
 * surprises.
 */
